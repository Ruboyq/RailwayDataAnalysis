...
<body>
	...
	<div class="nest map2" id="GmapClose">
		<div
			...
			<div class="oneline">
				...
				<span class="label1"><span class="label s1">选择的类别:</span><span
			...
			<div class="oneline">
				...
				<span class="label1"><span class="label s1">总发车数:</span><span id="carNums" class="s2"></span> </span>
			</div>
			<div class="oneline">
				<div class="entypo-tooltip" style="color: #3498DB">
	...
	var typeText;
	         ...
	         pointSimplifierIns.on('pointClick', function(e, record) {
	        	 if(!isRetrieve)
	              ...
	              $.ajax({
	  				...
	  				data:{"type":type,"cityName":cityName,"time":time},
	  				dataType:'json',
	  				success:function(data1){
	  					...
	  					$('#tt1').text('到达'+cityName+'的\"'+typeText+'类\"发送城市运量排名(前20)');
	  					$('#tt2').text('从'+cityName+'发送的\"'+typeText+'类\"货物到达城市运量排名(前20)');
	  					document.getElementById('analysisTitle').innerHTML="<small>"+cityName+"</small>";
	  				},
	  				error: function(json){
	  					load.loading.remove();
		...
		function retrieveLine() {
			...
			document.getElementById('analysisTitle').innerHTML="<small></small>"; 
			...
			$.ajax({
			    ...
			    $("#carNums").text(data1.carnums+"车");
	            $("#totalFreight").text(data1.totalFreight+"吨");
	            AMapUI.load(['ui/misc/PointSimplifier', 'lib/$', 'lib/utils'], function(PointSimplifier, $, utils) {
