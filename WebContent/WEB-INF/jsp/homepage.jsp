                ...
                <div class="side-bar">
                    <ul class="topnav menu-left-nest">
                        ...
                        <li>
                            ...
                            <ul>
                                <li>
                                    <a class="tooltip-tip2 ajax-load" href="<%=basePath%>user/list" title="Blog List" target="main"><i class="entypo-doc-text"></i><span>Blog List</span></a>
                                </li>
                                <li>
    ...
    <div class="wrap-fluid">
        <div class="container-fluid paper-wrap bevel tlbr">
            ...
            <div class="row" style="margin-top:30px;padding:0 15px;">
              <iframe  name="main" scrolling="auto" height="100%"
